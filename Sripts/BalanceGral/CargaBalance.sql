...
UPDATE TablaStD SET Valor ='OTROS DEUDORES'
WHERE Nombre LIKE '11050-0005%'
...
AND c.cuenta NOT IN ('11050-0002-002','11050-0002-032')

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'PATRONATO CUENTA CORRIENTE'
FROM Cta AS c
WHERE c.Cuenta LIKE '11050-0002-002%'
...
FROM Cta AS c
WHERE c.Cuenta LIKE '11050-0002-032%'
...
FROM Cta AS c
WHERE c.Cuenta LIKE '12020-0001-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'EDIFICIOS E INSTALACIONES'
FROM Cta AS c
WHERE c.Cuenta LIKE '12020-0002-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'DEPRECIACION EDIFICIOS E INSTALACIONES'
FROM Cta AS c
...
FROM Cta AS c
WHERE c.Cuenta LIKE '12020-0001-004%'


INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'GIMNASIOS'
FROM Cta AS c
WHERE c.Cuenta LIKE '12020-0002-003%'
...
FROM Cta AS c
WHERE c.Cuenta LIKE '12120-0006-000'
...
FROM Cta AS c
WHERE c.Cuenta LIKE '12120-0004-000%'
...
SELECT 'JalesBalanzaGral',c.Cuenta,'CONSTRUCCIONES EN PROCESO'
FROM Cta AS c
WHERE c.Cuenta LIKE '12050-0001-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'FONDO PARA OBLIGACIONES  LABORALES'
FROM Cta AS c
WHERE c.Cuenta  LIKE '51110%'
OR c.Cuenta LIKE '51120%'
OR c.Cuenta LIKE '51100%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'SEGUROS Y OTROS PAGOS'
FROM Cta AS c
WHERE c.Cuenta LIKE '13010%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'INDEMNIZACIONES'
FROM Cta AS c
...
SELECT 'JalesBalanzaGral',c.Cuenta,'OTRAS CONTRIBUCIONES'
FROM Cta AS c
WHERE c.Cuenta LIKE '21010-0016-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'OTRAS CONTRIBUCIONES'
FROM Cta AS c
WHERE c.Cuenta LIKE '21010-0017-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'OTRAS CONTRIBUCIONES'
FROM Cta AS c
WHERE c.Cuenta LIKE '21010-0018-000%'
...
INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'PROVISION PARA PRESTACIONES SOCIALES'
FROM Cta AS c
WHERE c.Cuenta LIKE '21050-0001-000%'
...
INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'PROV. PARA LIQUIDACIONES'
FROM Cta AS c
WHERE c.Cuenta LIKE '41010-0004-009%'
...
SELECT 'JalesBalanzaGral',c.Cuenta,'RESULTADO CICLO ESCOLAR'
FROM Cta AS c
WHERE c.Cuenta LIKE '61050-0000-000%'

INSERT INTO Tablastd
SELECT 'JalesBalanzaGral',c.Cuenta,'RESULTADO DEL EJERCICIO'
FROM Cta AS c
WHERE c.Cuenta LIKE '61050-0001-000%'
